...
<footer id="colophon" class="site-footer">
  ...
  <div class="site-info">
    <a class="no-external-link-indicator powered-by-wordpress" href="<?php echo esc_url( __( 'http://wordpress.org/', 'checkpoints' ) ); ?>">
      ...
      <span>
        <?php printf( esc_html__( 'Proudly powered by %s', 'checkpoints' ), 'WordPress' ); ?>.
      </span>
    </a>
    <span class="theme-info">
      <?php printf( esc_html__( 'Lightweight like %1$s itself. You are using version %2$s', 'checkpoints' ), '<i>air</i>', esc_attr( AIR_LIGHT_VERSION ) ); ?>
      <a class="no-external-link-indicator github-link" href="<?php echo esc_url( __( 'https://github.com/digitoimistodude/air', 'checkpoints' ) ); ?>">
